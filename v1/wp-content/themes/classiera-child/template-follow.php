			...
			<div class="col-lg-9 col-md-8 user-content-height">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title text-uppercase"><?php esc_html_e("Following / Followers", 'classiera') ?></h3>
					</div>
						...
						<div class="user-detail-section">
							...
							<div class="user-ads follower">
								...
								<?php
									...
									if (empty($results)) { ?>
										<div class="col-sm-12">
											<p class="follow-info"><?php esc_html_e('You Do Not Have Any Followers at The Moment...', 'classiera'); ?></p>
										</div>
									<?php }
								?>
							...
							<div class="user-ads follower">
								...
								<div class="row loop-content">
									...
									if (empty($results)) { ?>
										<div class="col-sm-12">
											<p class="follow-info"><?php esc_html_e('You Are Not Following Anyone at The Moment...', 'classiera'); ?></p>
										</div>
									<?php }
									?>
								</div>
