		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-6">
				<div class="category-box">
					<figure>
						...
						<div class="category-box-hover" style="background: <?php echo esc_html($iconColor); ?>">
							<span>								
								<?php 
							...
							<h3><a href="<?php echo esc_url($categoryLink); ?>"><?php echo esc_html(get_cat_name( $catName )); ?></a></h3>
							<p>
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="view-all text-center">
					<a href="<?php echo esc_url($allCatURL); ?>" class="btn btn-primary round outline btn-style-six"><?php esc_html_e( 'View All Categories', 'classiera' ); ?></a>
				</div>
			</div>
		</div>
	</div>
