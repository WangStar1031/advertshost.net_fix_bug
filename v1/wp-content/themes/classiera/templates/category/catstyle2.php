		...
		<div class="row">
								...
								foreach($subcategories as $category) {
									...
									<li>
										<a href="<?php echo esc_url($categoryLink); ?>" class="av-2" data-color="<?php echo esc_html($iconColor); ?>">
											<i class="fa fa-angle-<?php if(is_rtl()){echo "left";}else{echo "right";}?>"></i><?php echo esc_html($categoryTitle); ?> 
											<span>
											<?php if($classieraPostCount == 1){?>
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="view-all text-center">
					<a href="<?php echo esc_url($allCatURL); ?>" class="btn btn-primary round btn-style-two btn-md"><?php esc_html_e( 'View All Categories', 'classiera' ); ?><span><i class="fa fa-refresh"></i></span></a>
				</div>
			</div>
		</div>
	</div>
